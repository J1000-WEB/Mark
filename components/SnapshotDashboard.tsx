    ...
    <main className="min-h-screen p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-black">📸 Snapshot Center Mark4.3.1</h1>
            <p className="mt-1 text-sm font-semibold text-slate-500">현재 데이터 상태를 Snapshot_Master 시트에 저장합니다.</p>
          </div>
